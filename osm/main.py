...
if adres == 'y':
	...
	print(f'Building = yes          =  {result1.countElements()}, without height = {res_1}, written in txt = {written_1}')
	print(f'Building = apartments   =  {result2.countElements()}, without height = {res_2}, written in txt = {written_2}')
	print(f'Building = service      =  {result3.countElements()}, without height = {res_3}, written in txt = {written_3}')
	print(f'Building = school       =  {result4.countElements()}, without height = {res_4}, written in txt = {written_4}')
	print(f'Building = kindergarten =  {result5.countElements()}, without height = {res_5}, written in txt = {written_5}')
	print(f'Building = industrial   =  {result6.countElements()}, without height = {res_6}, written in txt = {written_6}')
